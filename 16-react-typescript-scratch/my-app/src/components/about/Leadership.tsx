        ...
        <div className="row">
          <div className="col-lg-6 col-xl-4 leader">
            ...
            <p>
              ...
              companies. Martin has his Masters degree in Information Technology
              with emphasis in Software Engineering. He is a proven leader of
          ...
          <div className="col-lg-6 col-xl-4 leader leader--column-2">
            ...
            <p>
              Martin's business education included common programming languages
              of the day, Basic, Fortran and Cobol. His proficiency at handling
              large databases led to opportunities in analytics early and
              eventually the head of operations for a large corporate bank in
              Illinois.
            </p>
            <p>
              Martin is proficiency with wide-ranging web server technologies;
              PHP, Java, JSP, Servlets, Spring, Spring Boot, C#, ASP.NET MVC,
              and Node.js. His proficient with NGINX and Apache servers. While
            ...
            <p>
              ...
              about the growth of Linux in recent years. Martin is well
              acquainted with HTML, CSS and JavaScript including React, Angular
            ...
            <p>
              ...
              rebuilding old PC's, upgrading hardware components, designing and
              configuring networks and network technologies.
            </p>
          </div>
          ...
          <div className="col-lg-6 col-xl-4 leader leader--column-3">
            ...
            <p>
              ...
              hundreds of companies, Martin enjoys breaking down business
              problems into software opportunities.
            </p>
            ...
            <p>
              ...
              roles in life. Husband to Rose. Father to Hollyann, Kyle, Casey
              and Noah. Friend to those with open minds and gentle hearts.
            </p>
            <p>
